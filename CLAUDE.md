# Project context — salesforce-sunrise-solar
...
- Intended org alias: sunrise.
- Package directory: force-app; source API version: 67.0.
- Org-to-repository metadata parity: unverified.

Sunrise connectivity and read-only query access were verified during the audit. Tracked metadata includes duplicate rules, matching rules, a layout, object-related files, reports and roles. Preserve existing evidence and distinctions between interim controls, completed remediation and unresolved tickets.
