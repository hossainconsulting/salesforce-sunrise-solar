# Engineering guidance — salesforce-sunrise-solar

Salesforce administration simulation for fictional SunRise Solar Solutions.

## Project context

Audit baseline recorded 2026-09-22; reverify before relying on it.

- Local folder: sunrise-solar-internship; GitHub repository: salesforce-sunrise-solar.
- Alias sunrise was connected and passed a read-only query during the audit.
- Tracked metadata includes duplicate rules, matching rules, a layout,
  object-related files, reports and roles.
- Preserve existing deliverables, evidence and carry-forward ticket history.
- Do not treat interim controls or unresolved tickets as completed remediation.
